...
model_1_training = model_1.fit(x=predictors, y=target, validation_split=0.4, epochs=20, callbacks=early_stopping_monitor)
model_2_training = model_2.fit(x=predictors, y=target, validation_split=0.4, epochs=20, callbacks=early_stopping_monitor)
